...
class OrbRenderer {
    ...
    const vec3 baseColor1=vec3(1.0,0.18,0.39);     /* EDITH crimson — primary orb mass         */
    const vec3 baseColor2=vec3(1.0,0.30,0.58);     /* EDITH magenta — rotating highlight point */
    const vec3 baseColor3=vec3(0.28,0.02,0.10);    /* EDITH deep rose — inner shadow / depth   */
